...
namespace WebHotel.Controllers
{
    public class RoomController : Controller
    {
        ...
        public ActionResult Index(RoomViewModel objRoomViewModel)
        {
            ...
            return Json(data: new {message = "Atividade executada Sucesso. -- " + message, success = true }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult DeleteRoomDetails(int roomId)
        {
            ...
            objHotelDBEntities.SaveChanges();
            return Json(data: new {message = "Registro Excluido com Sucesso.", success = true}, JsonRequestBehavior.AllowGet);
        }
    }
}